...
| 文件 | 内容 | 说明 |
|------|------|------|
| [为什么学习 Rust](./01-why-rust) | Rust 价值 | 解决的问题、核心优势、行业应用 |
| [安装与配置](./02-installation) | 环境搭建 | 跨平台安装、工具链、开发环境 |
| [快速上手](./03-quick-start) | 第一个项目 | Cargo 基础、创建运行、动手练习 |
| [常见问题](./04-faq) | FAQ | 安装问题、下载加速、工具链管理 |
