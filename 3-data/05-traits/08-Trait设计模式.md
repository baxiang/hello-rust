...
> 掌握 Trait 的设计哲学，学习组合优于继承的理念，深入理解标准库 Trait 的高级用法。
...
- 最小化 Trait 边界，只要求必要的约束
- 关联类型用于明确唯一类型，泛型参数用于多种类型
- Iterator、From/Into、Deref、Drop 是核心标准库 Trait
- 对象安全规则限制了 Trait 对象的能力
