...
| 文件 | 内容 | 说明 |
|------|------|------|
| [引用基础](./01-reference-basics) | 核心概念 | 引用语法、解引用、作用域 |
| [可变引用与借用规则](./02-mutable-refs-and-borrow-rules) | 借用规则 | mut引用、规则详解、悬垂引用 |
| [引用进阶](./03-advanced-references) | 高级用法 | 引用与所有权、解引用强制 |
| [实战总结](./04-practical-summary) | 最佳实践 | 借用规则实战技巧 |
| [借用检查器](./05-borrow-checker) | 工作原理 | NLL、常见错误解析 |
